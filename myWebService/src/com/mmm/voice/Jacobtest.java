...
public class Jacobtest {
	...
	public static void main(String[] args) {
		System.out.println("播放开始"+DataUtils.getStandardCurTimes());
		String text = "播放结束";
		Jacobtest.textToSpeech(text);
		System.out.println("播放结束"+DataUtils.getStandardCurTimes());
	}
